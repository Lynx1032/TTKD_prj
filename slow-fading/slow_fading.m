...
fadingStdDev = 1;       % phương sai fading chuẩn

% tạo mẫu kênh slow-fading
...
fading = db2mag(fadingStdDev * randn(numSamples, 1));        % độ lợi fading
...
channelSamples = sqrt(pathLoss) .* shadowing .* interpPathGain .* fading;
